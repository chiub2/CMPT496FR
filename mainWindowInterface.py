...
"")
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 1144, 543))
        ...
        self.addCourseButton_3 = QtWidgets.QPushButton(self.addCourseButtonWidget_3)
        self.addCourseButton_3.setMaximumSize(QtCore.QSize(16777215, 100))
        self.addCourseButton_3.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/blackIcons/BlackIcons/plus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addCourseButton_3.setIcon(icon1)
        self.addCourseButton_3.setIconSize(QtCore.QSize(50, 50))
        self.addCourseButton_3.setObjectName("addCourseButton_3")
        self.verticalLayout_21.addWidget(self.addCourseButton_3)
